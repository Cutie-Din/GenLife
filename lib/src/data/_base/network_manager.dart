...
import 'package:genlife_mobi/config/app_config.dart';
import 'package:genlife_mobi/src/shared/app_manager.dart';
...
extension AppAppDioExtension on Dio {
  ...
  Future<void> _refreshToken() async {
    ...
    final response = await get('${AppConfig.url}/refresh-token/$refreshToken');
