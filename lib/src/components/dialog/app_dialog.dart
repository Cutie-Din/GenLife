          ...
          return Column(
            ...
            children: [
              if (widget.title != null) ...[
                ...
                _buildTitle(context),
                const Gap(10),
                const Divider(height: 0.5, color: AppColors.black),
                const Gap(5),
              ],
              _buildBody(),
          ...
          child: Column(
            ...
            children: [
              if (widget.msg != null)
                Text(
                  widget.msg!,
                  style: AppTheme.of(context).text_16_500.copyWith(fontWeight: FontWeight.w400),
                  textAlign: TextAlign.center,
                ),
            ...
            InkWell(
              ...
              child: Container(
                ...
                child: Text(
                  widget.cancelText ?? '',
                  textAlign: TextAlign.center,
                  style: AppTheme.of(context).text_14_500.copyWith(color: AppColors.primary),
                ),
              ),
            ),
          ],
