...
class AppThemeData with Diagnosticable {
  ...
  factory AppThemeData.fromContext(BuildContext context) {
    ...
    theme.textFieldLabel = theme.text_14_500.copyWith(color: AppColors.black);
    theme.textFieldLabelDisabled = theme.textFieldLabel.copyWith(color: AppColors.black);
    theme.textFieldLabelFocused = theme.textFieldLabel.copyWith(color: AppColors.primary);
    theme.textFieldText = theme.text_16_500.copyWith(color: AppColors.black);
    theme.textFieldTextDisabled = theme.textFieldText.copyWith(color: AppColors.black);
    theme.textFieldHint = theme.text_14_400.copyWith(color: AppColors.black);
    theme.textFieldHintDisabled = theme.textFieldHint.copyWith(color: AppColors.black);
    theme.textFieldError = theme.text_14_500.copyWith(color: AppColors.primary);
    theme.textFieldErrorDisabled = theme.textFieldError.copyWith(color: AppColors.black);
